...
<Frame caption="The agent factory: the list on the left, the canvas and the creation form on the right.">
  <img src="/images/agents.jpg" alt="Agent factory with the agent list, the workflow canvas and the agent creation form" />
</Frame>
