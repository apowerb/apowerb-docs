...
| `airflow` | [Apache Airflow](https://airflow.apache.org/) | production-grade scheduler |
...
<Frame caption="The orchestrator screen: one row per agent, with its model, its schedule and a manual trigger.">
  <img src="/images/orchestrator.jpg" alt="Orchestrator screen listing agents with their model, schedule and run actions" />
</Frame>
